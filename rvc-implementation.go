...
func (impl *vcImpl) CreatePod(podConfig vc.PodConfig) (vc.VCPod, error) {
	return vc.CreatePod(podConfig)
}

func (impl *vcImpl) DeletePod(podID string) (vc.VCPod, error) {
	return vc.DeletePod(podID)
}

func (impl *vcImpl) StartPod(podID string) (vc.VCPod, error) {
	return vc.StartPod(podID)
}

func (impl *vcImpl) StopPod(podID string) (vc.VCPod, error) {
	return vc.StopPod(podID)
}

func (impl *vcImpl) RunPod(podConfig vc.PodConfig) (vc.VCPod, error) {
...
func (impl *vcImpl) PausePod(podID string) (vc.VCPod, error) {
	return vc.PausePod(podID)
}

func (impl *vcImpl) ResumePod(podID string) (vc.VCPod, error) {
	return vc.ResumePod(podID)
}

func (impl *vcImpl) CreateContainer(podID string, containerConfig vc.ContainerConfig) (vc.VCPod, vc.VCContainer, error) {
	return vc.CreateContainer(podID, containerConfig)
}

func (impl *vcImpl) DeleteContainer(podID, containerID string) (vc.VCContainer, error) {
	return vc.DeleteContainer(podID, containerID)
}

func (impl *vcImpl) StartContainer(podID, containerID string) (vc.VCContainer, error) {
	return vc.StartContainer(podID, containerID)
}

func (impl *vcImpl) StopContainer(podID, containerID string) (vc.VCContainer, error) {
	return vc.StopContainer(podID, containerID)
}

func (impl *vcImpl) EnterContainer(podID, containerID string, cmd vc.Cmd) (vc.VCPod, vc.VCContainer, *vc.Process, error) {
